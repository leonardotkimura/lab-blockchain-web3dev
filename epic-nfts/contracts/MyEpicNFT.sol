...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Cachorro", "Cavalo", "Pica-pau", "Urso", "Rato", "Dragao"];
  string[] secondWords = ["Vermelho", "Verde", "Azul", "Amarelo", "Rosa", "Negro"];
  string[] thirdWords = ["Raivoso", "Feroz", "Sabio", "Amoroso", "Serio", "Timido"];
